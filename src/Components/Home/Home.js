    ...
    return (
      <div>
        <figure className="Raymond">
          <img className="raypic" alt="" src={Ray} />
          <figcaption>
            <p className="homesum">
              Software Engineer with a background in secondary and higher
              education. My aptitude for learning and applying new concepts led
              me to General Assembly where I was thoroughly immersed in the
              field. I am proficient in
